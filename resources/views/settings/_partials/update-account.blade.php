                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="rounded-md shadow-sm">
                                <input class="block w-full mt-1 transition duration-150 ease-in-out form-input sm:text-sm sm:leading-5" placeholder="Your website" value="{{ auth()->user()->blog }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="rounded-md shadow-sm">
                                <textarea id="about"
                                          ...
                                          placeholder="Your GitHub Bio" readonly>{{ auth()->user()->bio }}</textarea>
                            </div>
                        </div>
